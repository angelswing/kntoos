...
public class FrameDetail  implements java.io.Serializable {
    ...
    public FrameDetail(int id, OrsOrder orsorder, FrameColor framecolor, FrameModel framemodel, Integer rboxasize, Integer lboxasize, Integer rboxbsize, Integer lboxbsize, Float rfittingheight, Float lfittingheight, Float rdistance, Float ldistance, Float dbl) {
       this.id = id;
       this.orsorder = orsorder;
