...
public class OrsOrder implements java.io.Serializable {
    ...
    public OrsOrder(int exist, int ordertype, int orderstatus, String clientname, String telephone, Date ordereddate, Date requesteddate) {
        this.exist = exist;
    ...
    public OrsOrder(int exist, int ordertype, int orderstatus, String clientname, String telephone, Date ordereddate, Date requesteddate, String referenceno, String courier, String couriercode, Date deliverydate, Date shipmentdate, LensDetail lensdetail, FrameDetail framedetail) {
       this.exist = exist;
       this.ordertype = ordertype;
       this.orderstatus = orderstatus;
       this.clientname = clientname;
