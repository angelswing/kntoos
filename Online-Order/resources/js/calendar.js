...
{
	//parent.meizzTheDate=；liuzhen
	//alert(meizzTheDate);
	//alert(parent.meizzTheDate);	
	...
	WriteDateTo(meizzTheYear,meizzTheMonth,parent.meizzTheDate,meizzTheHour,meizzTheMinute,meizzTheSecond)
}
