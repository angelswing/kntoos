	...
	<tr>
		...
		<table width="93%" border="1" align="center" cellpadding="0"
			...
			<tr>
				...
				Date&nbsp;</td>
				<td><spring:bind path="order.requesteddate">
					<input type="text" name="<c:out value="${status.expression}"/>"
				...
				Date&nbsp;</td>
				<td><spring:bind path="order.ordereddate">
					<input type="text" name="<c:out value="${status.expression}"/>"
						value="<c:out value="${status.displayValue}"/>"
						onFocus="setday(this)" />
					<c:if test="${status.error}">
			...
			<tr>
				...
				<td align="left" colspan="3"><spring:bind
					path="order.lensdetail.lensmodel">
			...
			<tr>
				...
				Diameter&nbsp;</td>
				<td align="left" width="35%"><spring:bind
					path="order.lensdetail.diameter">
				...
				<td align="left" width="35%"><spring:bind
					path="order.lensdetail.decentration">
			...
			<tr>
				...
				Cylinder&nbsp;</td>
				<td align="left" width="35%"><spring:bind
					path="order.lensdetail.rcylinder">
				...
				Cylinder&nbsp;</td>
				<td align="left" width="35%"><spring:bind
					path="order.lensdetail.lcylinder">
			...
			<tr>
				...
				<td align="left" width="35%"><spring:bind
					path="order.lensdetail.rbasecurve">
				...
				<td align="left" width="35%"><spring:bind
					path="order.lensdetail.lbasecurve">
